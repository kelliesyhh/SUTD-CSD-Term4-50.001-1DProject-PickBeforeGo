...
public class AddNewProductActivity extends AppCompatActivity{
        ...
        private Boolean Favourite=false, Discount=false, Stock=true;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            AddNewProductButton = (Button) findViewById(R.id.btnSubmit);
        ...
        private void SaveProductInfoToDatabase()
        {
            ...
            productMap.put("discountPercent", discountPercent);
            productMap.put("isPromo",Discount);
            productMap.put("isFavourite",Favourite);
            productMap.put("inStock", Stock);
